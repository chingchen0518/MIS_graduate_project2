...
const ScheduleItem = ({ editmode=false,a_id,name, position, width, index, s_id, onMove, editable=false,height,onValueChange,onDragStop,intervalHeight,nextAId, isHighlighted=false }) => {
    if(editmode){
        ...
        >
            <div
                ...
                style={{
                    ...
                    width: '100%',
                    height: '100%',
                    filter: isHighlighted ? 'brightness(1.3) saturate(1.2)' : 'none',
