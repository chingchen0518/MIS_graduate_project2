                ...
                <div className="user_info">
                    ...
                    <div className="vote_buttons">
                        <div className="vote_button_container">
                            ...
                            <div className="vote_glow like_glow" style={{ '--vote-count': voteData.total_likes }}></div>
                        </div>
                        <div className="vote_button_container">
                            <button
                            ...
                            <div className="vote_glow dislike_glow" style={{ '--vote-count': voteData.total_dislikes }}></div>
                        </div>
                    </div>
                </div>
