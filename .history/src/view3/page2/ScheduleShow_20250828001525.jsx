...
import Draggable from 'react-draggable'; // 引入 Draggable 組件
            ...
            <div className="schedule_timeline" style={{ position: 'relative', overflow: 'hidden', maxHeight: props.containerHeight }}>
                ...
                {scheduleItems.map((scheduleItem) => (
                    <Draggable
                        ...
                        onStop={(e, data) => {
                            console.log(`行程 ${scheduleItem.name} 被拖曳到位置:`, data);
                        }}
                    >
                        <div
                            ...
                            onMouseEnter={() => {
                                console.log(`顯示行程 ${scheduleItem.name} 的詳細資訊`);
                            }}
                            onMouseLeave={() => {
                                console.log(`隱藏行程 ${scheduleItem.name} 的詳細資訊`);
                            }}
                        >
                            {scheduleItem.name}
                        </div>
