...
const ScheduleShow = (props) => {
        ...
        const observer = new MutationObserver((mutations) => {
            mutations.forEach((mutation) => {
                if (mutation.type === 'childList' && !isAnimating) {
                    ...
                    if (initialPosition && currentRect) {
                        const positionChanged = Math.abs(currentRect.left - initialPosition.left) > 5 || 
                                              Math.abs(currentRect.top - initialPosition.top) > 5;
    ...
    }, [isAnimating, initialPosition, startSortingAnimation]);
