                ...
                <div className="user_info">
                    ...
                    <div className="vote_buttons">
                        ...
                        >
                            ...
                            <div className="vote_dots">
                                {Array.from({ length: Math.min(voteData.total_likes, 10) }, (_, i) => (
                                    <div key={`like-dot-${i}`} className="vote_dot like_dot"></div>
                                ))}
                                {voteData.total_likes > 10 && <span className="more_dots">...</span>}
                            </div>
                        </button>
                        <button
                        ...
                        >
                            <span className="vote_icon">👎</span>
                            <div className="vote_dots">
                                {Array.from({ length: Math.min(voteData.total_dislikes, 10) }, (_, i) => (
                                    <div key={`dislike-dot-${i}`} className="vote_dot dislike_dot"></div>
                                ))}
                                {voteData.total_dislikes > 10 && <span className="more_dots">...</span>}
                            </div>
                        </button>
                    </div>
                </div>
