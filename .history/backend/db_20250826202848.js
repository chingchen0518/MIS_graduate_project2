...
app.get('/api/user_vote/:t_id/:s_id/:u_id/:date', (req, res) => {
  ...
  console.log(`Fetching user vote for t_id:${t_id}, s_id:${s_id}, u_id:${u_id}, date:${date}`);
  ...
  connection.query(query, [t_id, s_id, u_id], (err, results) => {
    ...
    if (results.length === 0) {
      ...
      console.log(`User vote result: good=${vote.good}, bad=${vote.bad}, vote_type=${vote_type}`);
