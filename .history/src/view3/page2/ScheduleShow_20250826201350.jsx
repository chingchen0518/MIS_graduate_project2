                        ...
                        <div className="vote_bar_container">
                            <div
                                ...
                                style={{
                                    ...
                                    height: `${Math.min(35, 20 + (voteData.total_likes + voteData.total_dislikes) * 1.5)}px`,
                                    display: 'flex',
                                    alignItems: 'center',
                                    ...
                                    border: `${Math.min(3, 1 + (voteData.total_likes + voteData.total_dislikes) * 0.2)}px solid ${currentUserVote === 'like' ? '#2E7D32' : '#388E3C'}`,
                                    fontSize: `${Math.min(16, 12 + (voteData.total_likes + voteData.total_dislikes) * 0.4)}px`,
                                    fontWeight: voteData.total_likes + voteData.total_dislikes > 5 ? 'bold' : 'normal'
                                }}
                            ...
                            <div
                                ...
                                style={{
                                    ...
                                    border: `${Math.min(3, 1 + (voteData.total_likes + voteData.total_dislikes) * 0.2)}px solid ${currentUserVote === 'dislike' ? '#B71C1C' : '#C62828'}`,
                                    fontSize: `${Math.min(16, 12 + (voteData.total_likes + voteData.total_dislikes) * 0.4)}px`,
                                    fontWeight: voteData.total_likes + voteData.total_dislikes > 5 ? 'bold' : 'normal'
                                }}
