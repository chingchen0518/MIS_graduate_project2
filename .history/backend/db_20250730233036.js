...
app.get('/api/fake-data', async (req, res) => {
  try {
    // 插入 User
    const userSql = 
  INSERT INTO User (u_name, u_email, u_account, u_password, u_img, u_line_id)
  VALUES 
    ('TestUser1', 'testuser1@example.com', 'testuser1', '$2b$10$testpasswordhash1', NULL, 'line001'),
    ('TestUser2', 'testuser2@example.com', 'testuser2', '$2b$10$testpasswordhash2', NULL, 'line002'),
    ('TestUser3', 'testuser3@example.com', 'testuser3', '$2b$10$testpasswordhash3', NULL, 'line003'),
    ('TestUser4', 'testuser4@example.com', 'testuser4', '$2b$10$testpasswordhash4', NULL, 'line004'),
    ('TestUser5', 'testuser5@example.com', 'testuser5', '$2b$10$testpasswordhash5', NULL, 'line005')
;
