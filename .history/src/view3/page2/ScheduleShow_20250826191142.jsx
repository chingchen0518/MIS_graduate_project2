                ...
                <div className="user_info">
                    ...
                    <div className="vote_buttons">
                        ...
                        >
                            ...
                            <div className="vote_circle like_circle">
                                {Array.from({ length: props.totalUsers || 8 }, (_, index) => (
                                    <div
                                        key={index}
                                        className={`circle_dot ${index < voteData.total_likes ? 'active' : ''}`}
                                        style={{
                                            transform: `rotate(${(360 / (props.totalUsers || 8)) * index}deg) translateY(-20px)`,
                        ...
                        >
                            <span className="vote_icon">👎</span>
                            <div className="vote_circle dislike_circle">
                                {Array.from({ length: props.totalUsers || 8 }, (_, index) => (
                                    <div
                                        key={index}
                                        className={`circle_dot ${index < voteData.total_dislikes ? 'active' : ''}`}
                                        style={{
                                            transform: `rotate(${(360 / (props.totalUsers || 8)) * index}deg) translateY(-20px)`,
                                            transformOrigin: '50% 20px'
                                        }}
