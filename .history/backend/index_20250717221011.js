...
Hotel.belongsToMany(Schedule, { through: TripHotel, foreignKey: 'h_id', otherKey: 't_id' });
Schedule.belongsToMany(User, { through: faTemperatureHigh, foreignKey: 't_id', otherKey: 'h_id' });
