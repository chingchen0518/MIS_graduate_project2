...
const ScheduleShow = (props) => {
    ...
    }, [props.t_id, props.s_id, props.date, currentUserId, formatDate]); // 添加 currentUserId 到依賴項

    // 投票處理函數
    const handleVote = useCallback(async (voteType) => {
        if (!currentUserId) {
            console.log('用戶未登入，無法投票');
            return;
        }
    ...
    }, [currentUserVote, currentUserId, props.t_id, props.s_id, props.date, formatDate]); // 添加 currentUserId 到依賴項
