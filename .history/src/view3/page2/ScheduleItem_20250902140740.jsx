...
const ScheduleItem = ({ editmode = false, a_id, name, position, width, index, s_id, onMove, editable = false, height, onValueChange, onDragStop, intervalHeight, nextAId, isSelected = false, categoryColor, category, useTransition = false }) => {
    ...
    }, [position.x, position.y, useTransition]);
    ...
    return (
        <Rnd
            ...
            key={`${a_id}`}
            style={{
                transition: useTransition && !editable ? 'transform 0.5s cubic-bezier(0.4, 0, 0.2, 1)' : 'none',
            }}
        >
            <div
