...
const ScheduleShow = (props) => {
    ...
    const handleAttractionClick = useCallback((attraction) => {
        console.log('🔄 ScheduleShow 景點被點擊:', attraction);
    ...
    const handleScheduleClick = useCallback((event) => {
        console.log('🔄 ScheduleShow 行程被點擊, 顯示路線');
        console.log('scheduleItems:', scheduleItems);
        console.log('onShowRoute:', onShowRoute);
        
        if (onShowRoute && scheduleItems.length > 0) {
            ...
            console.log('傳遞路線資料給地圖:', routeData);
            onShowRoute(routeData);
        } else {
            console.log('⚠️ 沒有景點資料或回調函數');
            console.log('scheduleItems.length:', scheduleItems.length);
            console.log('onShowRoute存在:', !!onShowRoute);
        }
    ...
    const handleAttractionContainerClick = useCallback((event, scheduleItem) => {
        ...
        console.log('🎯 景點被點擊，清除路線並選擇景點:', scheduleItem.name);
    ...
    }, [handleAttractionClick, onHideRoute]);
