...
const ScheduleShow = (props) => {
    ...
    useEffect(() => {
        ...
        .then((data) => {
            ...
            // 計算總預算
            const total = data.reduce((sum, item) => sum + (parseFloat(item.budget) || 0), 0);
            ...
            <div className="schedule_header">
                <div className="user_info">
                    ...
                    <div className="vote_buttons">
                        <button 
                            className={`vote_btn like ${userVote === 'like' ? 'active' : ''}`}
                        ...
                        <button 
                            className={`vote_btn dislike ${userVote === 'dislike' ? 'active' : ''}`}
