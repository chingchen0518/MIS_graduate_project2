...
async function syncModels() {
  try {
    ...
    await models.TripHotel.sync({ alter: true });
    await models.TransportTime.sync({ alter: true });
    await models.ReAttraction.sync({ alter: true });
    await models.Comment.sync({ alter: true });
    await models.PlusAttraction.sync({ alter: true });
