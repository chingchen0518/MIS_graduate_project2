...
app.get('/api/fake-data', async (req, res) => {
  try {
    ...
    //tripHotel
    INSERT INTO Trip_Hotel (h_id, t_id, cin_time, cout_time)
VALUES
  (1, 1, '2025-08-01', '2025-08-03'),
  (2, 1, '2025-08-03', '2025-08-05'),
  (3, 2, '2025-09-05', '2025-09-06'),
  (4, 2, '2025-09-06', '2025-09-08'),
  (5, 3, '2025-10-10', '2025-10-12'),
  (6, 3, '2025-10-12', '2025-10-13'),
  (7, 4, '2025-11-01', '2025-11-03'),
  (8, 4, '2025-11-03', '2025-11-05'),
  (9, 5, '2025-12-15', '2025-12-17'),
  (10, 5, '2025-12-17', '2025-12-19'),

  (11, 1, '2025-08-05', '2025-08-07'),
  (12, 2, '2025-09-08', '2025-09-10'),
  (13, 3, '2025-10-13', '2025-10-14'),
  (14, 4, '2025-11-05', '2025-11-06'),
  (15, 5, '2025-12-19', '2025-12-21'),

  (16, 1, '2025-08-07', '2025-08-08'),
  (17, 2, '2025-09-10', '2025-09-12'),
  (18, 3, '2025-10-14', '2025-10-16'),
  (19, 4, '2025-11-06', '2025-11-08'),
