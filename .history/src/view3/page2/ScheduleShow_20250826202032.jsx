...
const ScheduleShow = (props) => {
    ...
    // 添加投票狀態調試信息
    useEffect(() => {
        console.log('Current user vote status changed:', {
            currentUserVote,
            voteData
        });
    }, [currentUserVote, voteData]);
    ...
    useEffect(() => {
        const fetchVotes = async () => {
            try {
                ...
                console.log(`Fetching user vote for user: ${currentUserId}, t_id: ${props.t_id}, s_id: ${props.s_id}, date: ${formattedDate}`);
                ...
                try {
                    ...
                    if (userVoteResponse.ok) {
                        ...
                        console.log('User vote API failed, setting to null');
    ...
    const handleVote = async (voteType) => {
        try {
            ...
            console.log('Vote action:', {
                ...
                finalVoteType,
                isCancel: currentUserVote === voteType
            });
            ...
            if (response.ok) {
                ...
                console.log('Vote updated, new state:', finalVoteType);
