...
const ScheduleShow = (props) => {
    ...
    const [dragPosition, setDragPosition] = useState({ x: 0, y: 0 }); // 拖曳位置
    ...
    const handleDragStop = (e, data) => {
        setIsDragging(false);
        console.log(`行程 ${props.s_id} 拖曳到位置:`, data);
        // 這裡可以添加保存位置的邏輯
    };
    ...
    return (
        ...
        >
            {/* //層級1：單個schedule */}
            <div
                className={`schedule scheduleShow ${isDragging ? 'dragging' : ''}`}
            ...
            >
                {/* //層級2：schedule的header */}
                <div className="schedule_header drag-handle" style={{ cursor: 'grab' }}>
