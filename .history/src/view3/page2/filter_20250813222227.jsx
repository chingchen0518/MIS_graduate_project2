    ...
    const handleAttractionToggle = (attractionId) => {
        setSelectedAttractions(prev => {
            ...
            if (attraction) {
                ...
                // 檢查該類別下是否有任何景點被選中
                const anyCategoryAttractionSelected = categoryAttractionIds.some(id =>
                    newSelectedAttractions.includes(id)
                );
                ...
                setSelectedCategories(prevCategories => {
                    ...
                    } else if (!anyCategoryAttractionSelected && prevCategories.includes(category)) {
                        // 如果該類別沒有任何景點被選中，取消勾選類別
