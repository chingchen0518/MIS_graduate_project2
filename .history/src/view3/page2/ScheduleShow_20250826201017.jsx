...
const ScheduleShow = (props) => {
    ...
    // 根據總投票數計算視覺效果
    const getVoteBarStyles = () => {
        const totalVotes = voteData.total_likes + voteData.total_dislikes;
        ...
        if (totalVotes === 0) {
            // 沒有投票：淡灰色，較小
            baseStyles.height = '25px';
            baseStyles.opacity = 0.6;
            baseStyles.border = '2px dashed #ccc';
        } else if (totalVotes <= 5) {
            // 少量投票：正常大小，輕微發光
            baseStyles.boxShadow = '0 0 8px rgba(0,0,0,0.1)';
        } else if (totalVotes <= 15) {
            // 中等投票：稍大一點，明顯發光
            baseStyles.height = '35px';
            baseStyles.boxShadow = '0 0 12px rgba(0,0,0,0.2)';
            baseStyles.transform = 'scale(1.02)';
        } else {
            // 大量投票：最大，強烈發光，動畫效果
            baseStyles.height = '40px';
            baseStyles.boxShadow = '0 0 16px rgba(0,0,0,0.3), 0 0 8px rgba(255,255,255,0.2)';
            ...
            <div className="schedule_header">
                <div className="user_info">
                    ...
                    <div className="vote_buttons">
                        <div className="vote_bar_container" style={getVoteBarStyles()}>
                            <div
