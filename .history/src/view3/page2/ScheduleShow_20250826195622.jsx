                        ...
                        <div className="vote_bar_container">
                            <div
                                ...
                                style={{
                                    ...
                                    backgroundColor: (() => {
                                        ...
                                        const intensity = Math.min(totalVotes * 0.4, 1); // 每票增加0.1的深度，最大為1
                                        const baseColor = { r: 76, g: 175, b: 80 }; // #4CAF50的RGB值
                                        const minOpacity = 0.1; // 最淺的顏色
                            ...
                            <div
                                ...
                                style={{
                                    ...
                                    backgroundColor: (() => {
                                        const totalVotes = voteData.total_likes + voteData.total_dislikes;
                                        const intensity = Math.min(totalVotes * 0.1, 1); // 每票增加0.1的深度，最大為1
                                        const baseColor = { r: 244, g: 67, b: 54 }; // #f44336的RGB值
                                        const minOpacity = 0.3; // 最淺的顏色
                                        const opacity = minOpacity + (1 - minOpacity) * intensity;
                                        return `rgba(${baseColor.r}, ${baseColor.g}, ${baseColor.b}, ${opacity})`;
                                    })(),
                                    height: '30px',
