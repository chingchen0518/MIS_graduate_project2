...
const ScheduleContainer = ({ t_id, usedAttractions = [], onAttractionUsed, onDateChange, filterConditions }) => {
    //State
            ...
            <div className="schedule_container_header">
                ...
                <div className="controls-wrapper">
                    <div className="sort-selector-wrapper">
                        ...
                        >
                            <option value="latest">最新行程</option>
                            <option value="attractions">總景點數</option>
                            <option value="duration">總遊玩時間</option>
                            <option value="categories">總類別數</option>
                        </select>
                    </div>
