                    ...
                    <div className="vote_buttons">
                        <div className="vote_container">
                            <button
                                ...
                                title="讚"
                            >
                                <div className="vote_circle">
                                    {/* 生成光圈虛線 */}
                                    {Array.from({ length: props.totalMembers || 5 }).map((_, index) => (
                                        <div
                                            key={`like-dash-${index}`}
                                            className={`dash ${index < voteData.total_likes ? 'active' : ''}`}
                                            style={{
                                                transform: `rotate(${(360 / (props.totalMembers || 5)) * index}deg) translateY(-25px)`,
                                            }}
                                        />
                                    ))}
                        ...
                        <div className="vote_container">
                            ...
                            >
                                <div className="vote_circle">
                                    ...
                                    {Array.from({ length: props.totalMembers || 5 }).map((_, index) => (
                                        <div
                                            key={`dislike-dash-${index}`}
                                            className={`dash ${index < voteData.total_dislikes ? 'active' : ''}`}
                                            style={{
                                                transform: `rotate(${(360 / (props.totalMembers || 5)) * index}deg) translateY(-25px)`,
                                            }}
                                        />
